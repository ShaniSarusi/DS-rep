...
#################################################################
# Dictionary for: step_detection_fusion_high_level_union_two_stages [Search space size is 10% of original]
#################################################################
space_fusion_high_level_union_two_stages = dict()
space_fusion_high_level_union_two_stages['mva_win'] = 2 + hp.randint('mva_win', 70)
space_fusion_high_level_union_two_stages['peak_min_thr'] = 0.01 + 0.01 * hp.randint('peak_min_thr', 60)
space_fusion_high_level_union_two_stages['peak_min_dist'] = 10 + hp.randint('peak_min_dist', 70)
...
space_fusion_high_level_union_two_stages['union_min_thresh'] = 0.01 + 0.01 * hp.randint('union_min_thresh', 50)

#################################################################
# Dictionary for: step_detection_fusion_high_level_union_one_stage
#################################################################
space_fusion_high_level_union_one_stage = dict()
space_fusion_high_level_union_one_stage['mva_win'] = 2 + hp.randint('mva_win', 70)
space_fusion_high_level_union_one_stage['peak_min_thr'] = 0.01 + 0.01 * hp.randint('peak_min_thr', 60)
space_fusion_high_level_union_one_stage['peak_min_dist'] = 10 + hp.randint('peak_min_dist', 70)
