...
space_fusion_high_level_union_two_stages['peak_min_dist'] = 10 + hp.randint('peak_min_dist', 118)
...
space_fusion_high_level_union_one_stage['peak_min_dist'] = 10 + hp.randint('peak_min_dist', 118)
