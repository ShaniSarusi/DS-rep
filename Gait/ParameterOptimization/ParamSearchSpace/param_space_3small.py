...
space_fusion_high_level_union_one_stage['mva_win'] = 35 + hp.randint('mva_win', 30)
space_fusion_high_level_union_one_stage['peak_min_thr'] = 0.01 + 0.01 * hp.randint('peak_min_thr', 25)
...
space_fusion_low_level['peak_min_dist'] = 25 + hp.randint('peak_min_dist', 35)
