...
d['p2_pu'] = 15 + hp.randint('p2_pu', 60)
...
d['win_size_merge'] = 2 + hp.randint('win_size_merge', 59)
d['win_size_remove_adjacent_peaks'] = 1 + hp.randint('win_size_remove_adjacent_peaks', 60)
...
space_overlap_strong['z'] = -2 + 0.1 * hp.randint('z', 40)
